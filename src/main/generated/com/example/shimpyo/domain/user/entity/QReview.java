...
public class QReview extends EntityPathBase<Review> {
    ...
    private static final long serialVersionUID = 1675552952L;
    ...
    public final ListPath<String, StringPath> image = this.<String, StringPath>createList("image", String.class, StringPath.class, PathInits.DIRECT2);
